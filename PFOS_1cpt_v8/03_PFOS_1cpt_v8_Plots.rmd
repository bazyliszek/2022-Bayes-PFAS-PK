---
title: "PFOS 1 compartment Plots (v8)"
...
in_file <- "PFOS_1cpt_v8.PopMCMC_MeanIndivTrainTest.in.R" 
...
load("PFOS_1cpt_v8_multicheck.Rdata")
```
...
p<-ggplot()+
  stat_density(aes(halflife_GM, color = "Prior", linetype="Prior"),data=PFOS_priors,geom="line",size=1)+
  stat_density(aes(PFOS_halflife_GM,stat(density),color="Posterior",linetype="Posterior"),geom="line",size=1.5 )+
  xlim(0,15)+
...
save(p,PFOS_priors,PFOS_halflife_GM,PFOS_hl_median_gm,PFOS_hl_median_gm_95ci,file=here("output-plots",paste0( sa, "PFOS_hl_gm.RData")))
```



```{r PFOS-half-life-gsd, message=FALSE, warning=FALSE,fig.height=2.5,fig.width=4,dpi=600}
...
PFOS_hl_gsd_med_95ci <- paste(signif(quantile(PFOS_halflife_GSD,
                                            prob=c(0.025,0.975)),3),collapse="-")
p<-ggplot()+
  stat_density(aes(halflife_GSD, color = "Prior", linetype="Prior"),data=PFOS_priors,geom="line",size=1)+
  stat_density(aes(PFOS_halflife_GSD,stat(density), color = "Posterior",linetype="Posterior"),geom="line",size=1.5)+
  xlim(1,3)+
...
save(p,PFOS_priors,PFOS_halflife_GSD,PFOS_hl_gsd_med,PFOS_hl_gsd_med_95ci,file=here("output-plots",paste0( sa, "PFOS_hl_gsd.RData")))
```
...
```{r PFOS-vd-gm, message=FALSE, warning=FALSE,fig.height=2.5,fig.width=4,dpi=600}
...
p<-ggplot()+
  stat_density(aes(Vd_GM, color = "Prior", linetype="Prior"),data=PFOS_priors,geom="line",size=1)+
  stat_density(aes(PFOS_Vd_GM,stat(density), color = "Posterior",linetype="Posterior"),geom="line",size=1.5)+
...
save(p,PFOS_priors,PFOS_Vd_GM,PFOS_vd_gm_med,PFOS_vd_gm_med_95ci,file=here("output-plots",paste0( sa, "PFOS_vd_gm.RData")))

```


```{r PFOS-vd-sd, message=FALSE, warning=FALSE,fig.height=2.5,fig.width=4,dpi=600}
...
p<-ggplot()+
  stat_density(aes(Vd_GSD, color = "Prior", linetype="Prior"),data=PFOS_priors,geom="line",size=1)+
  stat_density(aes(PFOS_Vd_GSD,stat(density), color = "Posterior",linetype="Posterior"),geom="line",size=1.5)+
  xlim(1,3)+
...
save(p,PFOS_priors,PFOS_Vd_GSD,PFOS_vd_gsd_med,PFOS_vd_gsd_med_95ci,file=here("output-plots",paste0( sa, "PFOS_vd_gsd.RData")))
...
```{r PFOS-cl-gm, message=FALSE, warning=FALSE,fig.height=2.5,fig.width=4,dpi=600}
...
p<-ggplot()+
  stat_density(aes(CL_GM, color = "Prior", linetype="Prior"),data=PFOS_priors,geom="line",size=1)+
  stat_density(aes(PFOS_CL_GM,stat(density), color = "Posterior",linetype="Posterior"),geom="line",size=1.5)+
  xlim(0,0.25)+labs(title = "C: PFOS CL Population GM ",subtitle=paste("Posterior Median (95% CI): ",
                                                                    PFOS_cl_gm_med," (",
                                                                    PFOS_cl_gm_med_95ci,
                                                                    ")",sep=""))+
...
save(p,PFOS_priors,PFOS_CL_GM,PFOS_cl_gm_med,PFOS_cl_gm_med_95ci,file=here("output-plots",paste0( sa, "PFOS_CL_gm.RData")))

```

```{r PFOS-CL-sd, message=FALSE, warning=FALSE,fig.height=2.5,fig.width=4,dpi=600}
...
p<-ggplot()+
  stat_density(aes(CL_GSD, color = "Prior", linetype="Prior"),data=PFOS_priors,geom="line",size=1)+
  stat_density(aes(PFOS_CL_GSD,stat(density), color = "Posterior",linetype="Posterior"),geom="line",size=1.5)+
  xlim(1,3)+
  labs(title = bquote("D: PFOS"~CL~"Population GSD "),
       subtitle=paste("Posterior Median (95% CI): ",
                      PFOS_CL_gsd_med," (",
...
save(p,PFOS_priors,PFOS_CL_GSD,PFOS_CL_gsd_med,PFOS_CL_gsd_med_95ci,file=here("output-plots",paste0( sa, "PFOS_CL_gsd.RData")))
...
| -------------------------------|:-------------:|:------------:|:-------------:|:-------------:| 
| Half-life (years)  | `r paste(PFOS_hlgm_pr_med) ` |   `r paste(PFOS_hl_median_gm) `    | `r  paste(PFOS_hlgsd_pr_med) `           | `r paste(PFOS_hl_gsd_med)`  | 
| HL  [95% CI]  |`r paste0("[",PFOS_hlgm_pr_med_95ci,"]")` | `r paste0( "[",PFOS_hl_median_gm_95ci,"]")`| `r paste0("[",PFOS_hlgsd_pr_med_95ci,"]")`| `r paste0( "[",PFOS_hl_gsd_med_95ci, "]")`|
| Volume of distribution    | `r paste(PFOS_vd_gm_pr_med) ` |    `r paste(  PFOS_vd_gm_med) `|   `r  paste(PFOS_vd_gsd_pr_med)`  |`r  paste(PFOS_vd_gsd_med)` |  
| $V_D$ [95% CI]    |`r paste0( "[",PFOS_vd_gm_pr_med_95ci,"]")`| `r paste0( "[",PFOS_vd_gm_med_95ci,"]")`| `r paste0("[",PFOS_vd_gsd_pr_med_95ci, "]")`| `r paste0(  "[",PFOS_vd_gsd_med_95ci, "]")`| 
| Clearance    | `r paste(PFOS_cl_gm_pr_med) ` |    `r paste(  PFOS_cl_gm_med) `|   `r  paste()`  |`r  paste()` |  
| $CL$ [95% CI]    |`r paste0( "[",PFOS_cl_gm_pr_med_95ci,"]")`| `r paste0( "[",PFOS_cl_gm_med_95ci,"]")`| `r paste0("[", "]")`| `r paste0(  "[", "]")`| 
